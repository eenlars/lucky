  ...
  if (!showHelp) {
    return (
      <button
        ...
        className="hidden fixed bottom-4 right-4 z-40 px-3 py-2 text-xs text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-300 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg shadow-sm hover:shadow transition-all flex items-center gap-2"
