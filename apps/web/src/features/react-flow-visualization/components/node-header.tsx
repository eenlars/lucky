...
import { Button, type ButtonProps } from "@/features/react-flow-visualization/components/ui/button"
import {
  DropdownMenu,
  DropdownMenuContent,
  DropdownMenuTrigger,
...
export type NodeHeaderLabelProps = HTMLAttributes<HTMLHeadingElement> & {
  asChild?: boolean
}
