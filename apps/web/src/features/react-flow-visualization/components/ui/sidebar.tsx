...
import { Sheet, SheetContent } from "@/features/react-flow-visualization/components/ui/sheet"
import { Skeleton } from "@/features/react-flow-visualization/components/ui/skeleton"
import {
  Tooltip,
  TooltipContent,
  TooltipProvider,
  TooltipTrigger,
} from "@/features/react-flow-visualization/components/ui/tooltip"
import { useIsMobile } from "@/features/react-flow-visualization/hooks/use-mobile"
...
>(({ side = "left", variant = "sidebar", collapsible = "offcanvas", className, children, ...props }, ref) => {
  ...
  return (
    ...
    >
      ...
      <div
        className={cn(
          "duration-200 fixed top-14 bottom-0 z-10 hidden h-[calc(100vh-56px)] w-(--sidebar-width) transition-[left,right,width] ease-linear md:flex",
          side === "left"
            ? "left-[70px] group-data-[collapsible=offcanvas]:left-[calc(70px-var(--sidebar-width))]"
