...
import { validateInvocationInputSchema } from "../lib/input-schema-validation"
import { SchemaValidationError } from "../lib/schema-validator"
...
describe("validateInvocationInputSchema", () => {
  beforeEach(async () => {
    ...
    const { validateWorkflowInputSchema } = await import("../lib/schema-validator")
