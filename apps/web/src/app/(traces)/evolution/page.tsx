...
export default function EvolutionPage() {
  ...
  const filteredAndSortedRuns = evolutionRuns.sort((a, b) => {
    if (!sortField) {
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 p-4 mb-6">
          <div className="flex items-center gap-4">
            ...
            <Button
              onClick={() => fetchRuns({ showLoading: true, reset: true })}
              disabled={loading}
              variant="outline"
              size="sm"
            >
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 p-4 space-y-4">
          ...
          <div className="flex items-center justify-between pt-3 border-t border-gray-200 dark:border-gray-700">
            ...
            <div className="flex items-center gap-6">
              ...
              {hasMore && (
                <Button
                  onClick={() => fetchRuns({ showLoading: true, reset: false })}
                  disabled={loading}
                  variant="link"
                  size="sm"
                  className="text-sm font-medium text-blue-600 dark:text-blue-400 hover:text-blue-700 dark:hover:text-blue-300 p-0 h-auto"
                >
                  Load more
                </Button>
              )}
              ...
              <table className="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                <thead className="bg-gray-50 dark:bg-gray-900">
                  <tr>
                    ...
                    <th
                      className="px-6 py-3 text-left text-xs font-medium text-gray-500 dark:text-gray-400 uppercase tracking-wider cursor-pointer hover:bg-gray-100 dark:hover:bg-gray-800 transition-colors"
                      onClick={() => handleSort("avg_accuracy_delta")}
                    >
                      <div className="flex items-center gap-1">
                        ...
                        <Link
                          ...
                          title={
                            run.avg_accuracy_delta != null
                              ? `${run.avg_accuracy_delta}% (avg(last) - avg(first))`
                              : "N/A"
                          }
                        >
