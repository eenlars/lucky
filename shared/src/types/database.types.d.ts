...
export type Database = {
    ...
    public: {
        ...
        Enums: {
            ...
            MessageRole: "delegation" | "result" | "feedback" | "data" | "error" | "control" | "any" | "result-error" | "aggregated" | "sequential";
...
export declare const Constants: {
    readonly public: {
        readonly Enums: {
            readonly EvolutionRunStatus: readonly ["running", "completed", "failed", "interrupted"];
            readonly FitnessMetric: readonly ["success_rate", "usd_cost", "custom"];
            readonly InvocationStatus: readonly ["running", "completed", "failed", "rolled_back"];
            readonly MessageRole: readonly ["delegation", "result", "feedback", "data", "error", "control", "any", "result-error", "aggregated", "sequential"];
            readonly WorkflowOperation: readonly ["init", "crossover", "mutation", "immigrant"];
        };
    };
};
export {};
