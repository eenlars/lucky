    ...
    <div className="group">
      <a className="group" href={href}>
        <div className="relative">
          ...
          />
          <div
            className="absolute top-0 left-[15px] w-[40px] h-[40px] flex items-center justify-center dark:text-[#666666] text-black group-hover:!text-primary pointer-events-none"
          >
            <NavIcon className={isActive ? "dark:!text-white" : ""}>
              {icon}
            </NavIcon>
          </div>
        </div>
