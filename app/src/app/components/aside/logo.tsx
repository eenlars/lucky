...
export function Logo() {
  return (
    <div className="absolute top-0 left-0 h-[70px] flex items-center justify-center bg-background border-b border-border transition-all duration-200 ease-[cubic-bezier(0.4,0,0.2,1)] w-[69px]">
      <a className="absolute left-[22px] transition-none" href="/">
        <svg
          width="28"
          height="28"
          viewBox="0 0 28 28"
