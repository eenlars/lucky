  ...
  return (
    <div className="min-h-screen bg-gray-50 p-8">
      <div className="max-w-7xl mx-auto">
        <h1 className="text-4xl font-bold text-gray-900 mb-8">Detailed Experimental Analysis</h1>
        ...
        <div className="mb-12">
          <h2 className="text-2xl font-semibold mb-6">Legacy Adaptive Behavior Analysis (Original Data)</h2>

          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
            {/* Average attempts by model and condition */}
            <div className="bg-white rounded-lg shadow-md p-6">
              <h3 className="text-lg font-semibold mb-4">Average Attempts by Model & Condition</h3>
              ...
              <p className="text-sm text-gray-600 mt-2">
                Lower attempts indicate better efficiency. Clear prompts consistently require fewer attempts.
              </p>
            </div>
                    ...
                    <div key={model} className="space-y-2">
                      ...
                      <div className="flex space-x-2">
                        <div className="flex-1">
                          <div className="text-sm text-gray-600">Vague: Optimal Split</div>
                        ...
                        <div className="flex-1">
                          <div className="text-sm text-gray-600">Clear: Optimal Split</div>
                          <div className="bg-gray-200 rounded-full h-4 relative">
                            <div
                          ...
                          .map((run, idx) => (
                            <div
                              ...
                              className={`w-12 h-8 rounded flex items-center justify-center text-xs font-medium ${
                                run.adapted ? "bg-green-100 text-green-800" : "bg-red-100 text-red-800"
                              }`}
        ...
        <div className="mb-12">
          <h2 className="text-2xl font-semibold mb-6">Sequential Execution Analysis</h2>

          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            {/* Performance by Chain Complexity */}
            <div className="bg-white rounded-lg shadow-md p-6">
              <h3 className="text-lg font-semibold mb-4">Success Rate by Chain Length</h3>
              <ResponsiveContainer width="100%" height={300}>
                <BarChart
                  data={(() => {
            ...
            <div className="bg-white rounded-lg shadow-md p-6">
              <h3 className="text-lg font-semibold mb-4">Execution Time by Chain Length</h3>
              <ResponsiveContainer width="100%" height={300}>
                <LineChart
                  data={(() => {
                ...
                >
                  ...
                  <Line type="monotone" dataKey="o3" stroke={modelColors["o3"]} strokeWidth={2} />
                </LineChart>
              </ResponsiveContainer>
              <p className="text-sm text-gray-600 mt-2">o3 timed out on 10-step chain. Times shown in seconds.</p>
            </div>
          </div>

          {/* Sequential Execution Status Grid */}
          <div className="bg-white rounded-lg shadow-md p-6 mt-6">
            <h3 className="text-lg font-semibold mb-4">Execution Status by Model and Chain</h3>
        ...
        <div className="bg-white rounded-lg shadow-md p-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              <h3 className="font-semibold mb-2">Adaptive Behavior Experiment</h3>
            ...
            <div>
              <h3 className="font-semibold mb-2">Sequential Execution Experiment</h3>
              <ul className="space-y-1 text-sm">
