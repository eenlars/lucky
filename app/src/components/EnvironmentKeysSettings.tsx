...
export default function EnvironmentKeysSettings() {
  ...
  const handleSave = () => {
    ...
    if (emptyKeys.length > 0) {
      toast.error(
        "Please fill in all key names and values, or remove empty entries"
      )
      return
    }
    ...
    const duplicates = keyNames.filter(
      (name, index) => keyNames.indexOf(name) !== index
    )
    ...
    <div className="p-6 space-y-6">
      <div>
        ...
        <p className="text-sm text-gray-600 mt-1">
          Manage your API keys and environment variables for workflows
        </p>
      </div>
      ...
      <div className="space-y-4">
            ...
            <div className="flex-1">
              ...
              <div className="relative">
                ...
                <Button
                  ...
                  aria-label={
                    key.isVisible ? "Hide key value" : "Show key value"
                  }
        ...
        {keys.length === 0 && (
          <div className="text-center py-8 text-gray-500">
            No environment keys configured. Add one to get started.
          </div>
        )}
      </div>
      ...
      <div className="mt-6 p-4 bg-blue-50 border border-blue-200 rounded-lg">
        ...
        <p className="text-sm text-blue-700">
          ...
          untrusted code and keep your browser free of extensions you don’t
          trust. Never share your API keys or store them in version control.
        </p>
      </div>
    </div>
  )
