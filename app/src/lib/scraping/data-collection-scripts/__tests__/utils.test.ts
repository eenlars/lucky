...
test("slugify", () => {
  //do not change!
  const inputExpected = {
    "Próxima Comunicación y Relaciones Públicas": "prxima-comunicacin-y-relaciones-pblicas",
    "Make The Change Pte Ltd": "make-the-change-pte-ltd",
    "Tintoria P.A. Jacchetti srl Società Benefit": "tintoria-pa-jacchetti-srl-societ-benefit",
