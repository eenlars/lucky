...
export const inputValidatorSpec = tool({
  ...
  inputSchema: zodSchema(InputValidatorParams),
...
export const metadataExtractorSpec = tool({
  ...
  inputSchema: zodSchema(MetadataExtractorParams),
...
export const contentClassifierSpec = tool({
  ...
  inputSchema: zodSchema(ContentClassifierParams),
...
export const workflowRouterSpec = tool({
  ...
  inputSchema: zodSchema(WorkflowRouterParams),
...
export const outputFormatterSpec = tool({
  ...
  inputSchema: zodSchema(OutputFormatterParams),
