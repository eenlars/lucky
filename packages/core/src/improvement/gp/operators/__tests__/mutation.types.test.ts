...
describe("Mutation Types", () => {
  describe("MUTATION_WEIGHTS", () => {
    it("should have weights that sum to 1.0", () => {
      const totalWeight = MUTATION_WEIGHTS.reduce((sum, weight) => sum + weight.weight, 0)
    ...
    it("should include iterative mutation", () => {
      ...
      expect(iterativeWeight?.description).toBe("Iterative improvement via unified approach")
    })
