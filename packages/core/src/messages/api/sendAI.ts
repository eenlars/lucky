...
async function execStructured<S extends ZodTypeAny>(
  ...
  try {
    const { genObject } = await import("./genObject")
...
export const sendAI: SendAI = async (
  ...
  // extract
  // EXAMPLE OUTPUT of callerFile => '    at Function.mutatePrompt (/Users/here/CODE_FOLDER/main-projects/thesis/lucky/app/src/core/improvement/gp/operators/Mutations.ts'
