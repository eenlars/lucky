...

{
    ...
    modelName: string // openrouter#openai/gpt-4.1-mini, openrouter#google/gemini-2.5-flash-lite, etc. (some are free, some paid, some are more powerful but take longer and cost more)
