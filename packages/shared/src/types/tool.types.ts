/**
 * Code tool execution result types
 */

import { JSONN } from "../utils/files/json/jsonParse"

// Generic code tool name type - will be string for now
export type CodeToolName = string
