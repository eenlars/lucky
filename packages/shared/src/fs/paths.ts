...
function fromHere(relativePath: string, meta: string = import.meta.url): string {
...
export async function readJson<T = unknown>(relativePath: string, meta: string = import.meta.url): Promise<T> {
