 ...
 * Central registry of all available tools with their descriptions
 */

// Tool definitions - must be defined before types are derived from it
export const TOOLS = {
  mcp: {
...
// Derive tool name types from TOOLS constant
 ...
 * Controls which tools are active and behavioral settings
 */
export interface ToolConfig {
  ...
  /** Max rounds for multi-step loop */
