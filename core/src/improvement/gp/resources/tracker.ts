...
class FailureTracker {
  ...
  constructor() {
    ...
    console.log(
      `[FailureTracker] Tracking file will be saved to: ${this.outputPath}`
    )
  ...
  trackMutationFailure() {
    ...
    console.log(
      `[FailureTracker] Mutation failure tracked. Total: ${this.stats.mutationFailures}`
    )
    this.saveToFile()
  }
  ...
  trackCrossoverFailure() {
    ...
    console.log(
      `[FailureTracker] Crossover failure tracked. Total: ${this.stats.crossoverFailures}`
    )
    this.saveToFile()
  }
  ...
  trackImmigrationFailure() {
    ...
    console.log(
      `[FailureTracker] Immigration failure tracked. Total: ${this.stats.immigrationFailures}`
    )
    this.saveToFile()
  }
  ...
  trackEvaluationFailure() {
    ...
    console.log(
      `[FailureTracker] Evaluation failure tracked. Total: ${this.stats.evaluationFailures}`
    )
    this.saveToFile()
  }
    ...
    return {
      mutationFailureRate:
        this.stats.totalAttempts.mutations > 0
          ? (this.stats.mutationFailures / this.stats.totalAttempts.mutations) *
            100
          : 0,
