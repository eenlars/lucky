...
describe.skip("Observability Integration Tests", () => {
  ...
  describe("Complete Event Flow Integration", () => {
    it("should flow events from obs through SSESink to clients", async () => {
      ...
      sseSink.addConnection("client-1", client1 as any, {
        metadata: { invocationId },
      })
      sseSink.addConnection("client-2", client2 as any, {
        metadata: { invocationId },
      })
      sseSink.addConnection("client-3", client3 as any, {
        metadata: { invocationId: "different-invocation" },
      })
    ...
    it("should handle real-time event streaming during workflow execution", async () => {
      ...
      sseSink.addConnection("real-time-client", client1 as any, {
        metadata: { invocationId },
      })
      ...
      for (let i = 1; i < eventCollector.length; i++) {
        expect(eventCollector[i].timestamp).toBeGreaterThanOrEqual(
          eventCollector[i - 1].timestamp
        )
      }
  ...
  describe("Multiple Client Scenarios", () => {
    it("should handle concurrent clients for the same workflow", async () => {
      ...
      for (let i = 0; i < clientCount; i++) {
        ...
        clients.push(client)
        sseSink.addConnection(`concurrent-client-${i}`, client as any, {
          metadata: { invocationId },
        })
      }
    ...
    it("should handle clients connecting at different times", async () => {
      ...
      const executionPromise = obs.scope(context, async () => {
        ...
        sseSink.addConnection("early-client", client1 as any, {
          metadata: { invocationId },
        })
        ...
        sseSink.addConnection("mid-client", client2 as any, {
          metadata: { invocationId },
        })
        ...
        sseSink.addConnection("late-client", client3 as any, {
          metadata: { invocationId },
        })
  ...
  describe("Error Handling and Recovery", () => {
    it("should handle client disconnections gracefully", async () => {
      ...
      sseSink.addConnection("stable-client", client1 as any, {
        metadata: { invocationId },
      })
      sseSink.addConnection("unstable-client", client2 as any, {
        metadata: { invocationId },
      })
    ...
    it("should handle errors in event emission gracefully", async () => {
      ...
      sseSink.addConnection("faulty-client", faultyClient as any, {
        metadata: { invocationId },
      })
      sseSink.addConnection("stable-client", client1 as any, {
        metadata: { invocationId },
  ...
  describe("Memory Management and Performance", () => {
    it("should handle high-frequency events without memory leaks", async () => {
      ...
      sseSink.addConnection("memory-client", client1 as any, {
        metadata: { invocationId },
      })
    ...
    it("should clean up resources properly", async () => {
      ...
      for (let i = 0; i < connectionCount; i++) {
        const client = new MockSSEController()
        clients.push(client)
        sseSink.addConnection(`cleanup-client-${i}`, client as any, {
          metadata: { invocationId: `invocation-${i}` },
        })
      }
  ...
  describe("Observability Setup Integration", () => {
    ...
    it("should configure SSE-only mode correctly", () => {
      ...
      sseSink.addConnection("sse-only-client", client1 as any, {
        metadata: { invocationId: testInvocationId },
      })
