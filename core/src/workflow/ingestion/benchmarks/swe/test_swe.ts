...
async function solveSWEBenchInstance(instance: SWEBenchInstanceFull) {
  console.log("\n🤖 Attempting to solve SWE-bench instance with AI...")
  console.log("=".repeat(60))
...
async function testSWEBenchAISolver() {
  console.log("🔬 Testing SWE-bench AI Solver with Validation")
  console.log("=".repeat(50))

  try {
    // Step 1: Get a random SWE-bench instance
    console.log("\n📚 Fetching random SWE-bench instance...")
    ...
    console.log("\n🎉 SWE-bench AI Solver test completed successfully!")
    console.log("=".repeat(50))
...
async function testBasicSWEBenchLoader() {
  console.log("🧪 Testing basic SWEBenchLoader functionality...")

  try {
    const result = await SWEBenchLoader.fetchById("django__django-11099")
    console.log("✅ Basic loader test passed!")
...
async function runTests() {
  console.log("🚀 Starting SWE-bench AI Solver Tests with Validation")
